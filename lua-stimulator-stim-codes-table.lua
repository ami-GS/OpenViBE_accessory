...
-- This is almost same as "lua-stimulator-stim-codes.lua".
-- Mainly focuses on table for easy use.
-- Usage
-- move this script to directory as below
-- dofile(box:get_config("${Path_Data}") .. "/plugins/stimulation/lua-stimulator-stim-codes-table.lua")
